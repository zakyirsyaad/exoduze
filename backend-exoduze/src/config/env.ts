...
const envSchema = z.object({
  ...
  AUTONOMOUS_AI_DECISION_REFRESH_ENABLED: enabledBooleanStringSchema,
  AUTONOMOUS_AI_DECISION_REFRESH_INTERVAL_SECONDS: z.coerce.number().int().positive().default(900),
  AUTONOMOUS_AI_DECISION_REFRESH_BATCH_SIZE: z.coerce.number().int().positive().max(50).default(10),
  AUTONOMOUS_AI_DECISION_REFRESH_MAX_SEQUENCE: z.coerce.number().int().positive().max(500).default(64),
