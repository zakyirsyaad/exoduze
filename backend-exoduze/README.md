...
- The main tuning env vars are:
  ...
  - `AUTONOMOUS_AI_DECISION_REFRESH_ENABLED`
  - `AUTONOMOUS_AI_DECISION_REFRESH_INTERVAL_SECONDS`
  - `AUTONOMOUS_AI_DECISION_REFRESH_BATCH_SIZE`
  - `AUTONOMOUS_AI_DECISION_REFRESH_MAX_SEQUENCE`
